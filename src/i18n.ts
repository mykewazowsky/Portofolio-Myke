...
export const UI_COPY = {
  en: {
    ...
    layerLegend: 'Layer_Legend',
    mobileMapStatus: 'Map index locked',
    modalMapIndex: 'Map_Sheet_Index',
    researchMetadata: 'Spatial_Metadata',
  ...
  id: {
    ...
    layerLegend: 'Legenda_Layer',
    mobileMapStatus: 'Indeks peta aktif',
    modalMapIndex: 'Indeks_Lembar_Peta',
    researchMetadata: 'Metadata_Spasial',
